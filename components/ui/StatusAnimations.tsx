    ...
    <div className={`w-full ${className}`}>
      <div className="flex justify-between items-center mb-2">
        <div className="flex items-center space-x-2">
          <StatusIndicator
            status={status === "active" ? "loading" : status}
            size="sm"
          />
          {showPercentage && (
            <motion.span
...
export const AnimatedCheckmark = ({
  ...
  const colorMap: Record<"green" | "blue" | "purple" | "red", string> = {
    green: "#10b981",
    blue: "#3b82f6",
    purple: "#8b5cf6",
    red: "#ef4444",
...
export const AnimatedError = ({
  ...
  const colorMap: Record<"red" | "orange", string> = {
    red: "#ef4444",
    orange: "#f97316",
  };
...
// Warning animation
export const AnimatedWarning = ({
  size = 64,
  color = "yellow",
}: AnimatedWarningProps) => {
  const colorMap: Record<"yellow" | "orange", string> = {
    yellow: "#eab308",
    orange: "#f97316",
  };
