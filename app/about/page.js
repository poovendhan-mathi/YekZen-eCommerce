      ...
      <div className="relative bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto opacity-90">
            Your premier destination for premium products and exceptional shopping experiences
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-lg text-gray-600 mb-6">
                Founded in 2025, YekZen has quickly become a trusted name in premium eCommerce. 
                We started with a simple vision: to create a shopping experience that combines 
                the convenience of online shopping with the quality and service you'd expect 
                from a luxury boutique.
              </p>
              <p className="text-lg text-gray-600 mb-6">
                Our team of passionate professionals works tirelessly to curate the finest 
                selection of products from around the world, ensuring that every item meets 
                our exacting standards for quality, style, and value.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                ...
                you have an exceptional shopping experience.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                We're committed to sustainable practices and supporting brands that 
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied customers who trust YekZen for their premium shopping needs.
          </p>
